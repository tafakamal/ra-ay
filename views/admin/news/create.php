...
<div class="panel-card">
    <div class="panel-header">
        <h2 class="panel-title"><i class="ti ti-news"></i> Tambah Berita Baru</h2>
    ...
    <div class="panel-body">
        <form action="<?= url('/admin/news/store') ?>" method="POST" enctype="multipart/form-data" id="newsForm">
            <?= csrf_field() ?>
            ...
            <div class="form-row form-row-2">
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="Masukkan judul berita yang menarik" required>
                    </div>

                    <div class="form-group">
                        <label for="excerpt" class="form-label">Ringkasan Singkat (Excerpt)</label>
                        <textarea name="excerpt" id="excerpt" class="form-control" rows="3" placeholder="Ringkasan berita (jika dikosongkan, akan diambil dari awal konten)"></textarea>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-select">
                            <option value="draft" selected>Draft (Belum Diterbitkan)</option>
                    ...
                    <div class="form-group">
                        ...
                        <span class="form-text">Format yang diperbolehkan: JPG, JPEG, PNG, WEBP. Maksimal 5MB.</span>
                        <div style="margin-top: 1rem;">
                            <img id="imagePreview" src="#" alt="Preview Gambar" style="max-width: 100%; height: auto; border-radius: 8px; border: 1px solid var(--border); display: none;">
                        </div>
                    </div>
                    ...
                    <div style="border: 1px solid var(--border); border-radius: 8px; margin-top: 2rem;">
                        ...
                        <div style="padding: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" id="meta_title" class="form-control" placeholder="Judul SEO">
                            </div>
                            <div class="form-group">
                                <label for="meta_description" class="form-label">Meta Description</label>
                                <textarea name="meta_description" id="meta_description" class="form-control" rows="2" placeholder="Deskripsi SEO"></textarea>
                            </div>
                            <div class="form-group" style="margin-bottom: 0;">
                                <label for="meta_keywords" class="form-label">Meta Keywords</label>
                                <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" placeholder="keyword1, keyword2, dst.">
                            </div>
                        </div>
                    </div>
                </div>
