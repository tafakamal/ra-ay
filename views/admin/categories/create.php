...
<div class="panel-card" style="max-width: 600px; margin: 0 auto;">
    <div class="panel-header">
        <h2 class="panel-title"><i class="ti ti-category"></i> Tambah Kategori Baru</h2>
    ...
    <div class="panel-body">
        <form action="<?= url('/admin/categories/store') ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Kegiatan Sekolah, Pengumuman, Akademik" required>
            </div>
            ...
            <div class="form-row form-row-2">
                <div class="form-group">
                    ...
                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                        <input type="color" name="color" id="color" class="form-control" value="#E8600A" style="width: 60px; padding: 0.2rem; height: 38px; cursor: pointer;">
                        <input type="text" id="color_text" class="form-control" placeholder="#E8600A" value="#E8600A" readonly>
                    </div>
