...
<section class="section py-12 bg-surface">
  <div class="container">
    <div data-animate="fade-in">
      ...
      <p class="text-lg text-muted max-w-2xl">Perpaduan Kurikulum Nasional dan kurikulum Kemenag berbasis adab keislaman untuk tumbuh kembang optimal.</p>
    </div>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:grid-cols-3 lg:col-span-3" data-animate="slide-up">
        <div class="bg-card border rounded p-6 md:p-10 shadow-sm">
          ...
          <!-- Curriculum Banner Image -->
          <div class="mb-8 rounded overflow-hidden shadow-sm" style="aspect-ratio: 21/9; max-height: 350px;">
            <img src="https://placehold.co/800x400/FFF0E5/E8600A?text=Proses+Belajar+Mengajar+Kurikulum+Islam" alt="Kurikulum RA Attakal Yaqiin" class="w-full h-full" style="object-fit: cover;">
          </div>
      ...
      <aside class="lg:col-span-1" data-animate="slide-left">
        <div class="bg-card border rounded p-6 sticky" style="top: calc(var(--navbar-height) + var(--space-4));">
          ...
          <ul class="flex flex-col gap-2">
            <li>
              <a href="/akademik/kurikulum" class="flex items-center gap-2 px-3 py-2 rounded text-sm font-semibold transition bg-primary text-white">
                <i class="ti ti-book" style="font-size: 18px;"></i>
                Kurikulum
              </a>
            </li>
            <li>
              <a href="/akademik/program-unggulan" class="flex items-center gap-2 px-3 py-2 rounded text-sm font-medium transition text-fg-muted hover:bg-primary-light hover:text-primary">
