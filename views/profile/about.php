...
<section class="section py-12 bg-surface">
  <div class="container">
    <div data-animate="fade-in">
      ...
      <p class="text-lg text-muted max-w-2xl">Mengenal lebih dekat sejarah, identitas, dan dedikasi RA Attakal Yaqiin dalam mendidik generasi penerus Islam.</p>
    </div>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:grid-cols-3 lg:col-span-3" data-animate="slide-up">
        <div class="bg-card border rounded p-6 md:p-10 shadow-sm">
          ...
          <!-- Featured Image (Optional / placeholder for about us) -->
          <div class="mb-8 rounded overflow-hidden shadow-sm" style="aspect-ratio: 21/9; max-height: 350px;">
            <img src="https://placehold.co/800x400/FFF0E5/E8600A?text=Gedung+Sekolah+RA+Attakal+Yaqiin" alt="Gedung Sekolah RA Attakal Yaqiin" class="w-full h-full" style="object-fit: cover;">
          </div>
      ...
      <aside class="lg:col-span-1" data-animate="slide-left">
        <div class="bg-card border rounded p-6 sticky" style="top: calc(var(--navbar-height) + var(--space-4));">
          ...
          <ul class="flex flex-col gap-2">
            <li>
              <a href="/profil/tentang" class="flex items-center gap-2 px-3 py-2 rounded text-sm font-semibold transition bg-primary text-white">
