...
<section class="section py-12 bg-surface">
  <div class="container">
    <div data-animate="fade-in">
      ...
      <p class="text-lg text-muted max-w-2xl">Arah, cita-cita luhur, dan misi strategis RA Attakal Yaqiin untuk mendampingi masa keemasan buah hati Anda.</p>
    </div>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:grid-cols-3 lg:col-span-3" data-animate="slide-up">
        <div class="bg-card border rounded p-6 md:p-10 shadow-sm">
          ...
          <!-- Vision Banner (Islamic Calligraphy style background) -->
          <div class="mb-8 rounded p-8 text-center" style="background: linear-gradient(135deg, var(--primary-lighter) 0%, rgba(232, 96, 10, 0.04) 100%); border-left: 4px solid var(--primary);">
            <i class="ti ti-target text-primary" style="font-size: 40px; display: block; margin-bottom: var(--space-3);"></i>
            <h2 class="text-xl font-bold text-fg mb-2" style="margin-top:0;">Fokus Utama Pendidikan Kami</h2>
            <p class="text-sm text-fg-muted italic">Membentuk pondasi keagamaan, kecerdasan sosial-emosional, dan motorik anak sejak usia dini agar siap menjadi insan yang mulia.</p>
          </div>
      ...
      <aside class="lg:col-span-1" data-animate="slide-left">
        <div class="bg-card border rounded p-6 sticky" style="top: calc(var(--navbar-height) + var(--space-4));">
          ...
          <ul class="flex flex-col gap-2">
            ...
            <li>
              <a href="/profil/visi-misi" class="flex items-center gap-2 px-3 py-2 rounded text-sm font-semibold transition bg-primary text-white">
